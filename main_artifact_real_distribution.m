...
% num_rec=[500,1000,1200,1300,1400,1500];
repeat_times=1;
fprintf('rome real distribution function1: \n');
main_func1_10times_real;
fprintf('rome real distribution function2: \n');
main_func2_10times_real;
fprintf('rome real distribution function3: \n');
main_func3_10times_real;
